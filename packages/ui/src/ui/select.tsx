    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                ...
                'flex w-fit items-center justify-between gap-2 rounded-xl border px-3 py-2 text-sm whitespace-nowrap transition-all outline-none',
                'cursor-pointer focus-visible:ring-2 focus-visible:ring-zinc-400/50 dark:focus-visible:ring-zinc-600/50',
...
function SelectItem({
    ...
    return (
        <SelectPrimitive.Item
            ...
            className={cn(
                'relative flex cursor-default select-none items-center rounded-sm gap-1.5 px-2 py-1.5 text-sm outline-none transition-colors focus:bg-zinc-200 focus:text-zinc-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-zinc-700 dark:focus:text-zinc-50',
                className
            )}
            {...props}>
